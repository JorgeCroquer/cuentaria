  ...
  group('EnvelopeTarget', () {
    group('NoTarget', () {
      ...
      test('round-trips through JSON', () {
        const t = NoTarget();
        final json = t.toJson();
        expect(EnvelopeTarget.fromJson(json), const NoTarget());
      });
    });
    ...
    group('Cap', () {
      ...
      test('round-trips through JSON', () {
        ...
        expect(EnvelopeTarget.fromJson(t.toJson()), const Cap(amountUsd: 30000));
      });
    });
    ...
    group('GoalLine', () {
      ...
      test('round-trips through JSON without date', () {
        ...
        expect(EnvelopeTarget.fromJson(t.toJson()), const GoalLine(amountUsd: 75000));
      });
    });
    ...
    group('fromJson — invalid type throws', () {
      test('unknown type key throws FormatException', () {
        expect(
          () => EnvelopeTarget.fromJson({'type': 'unknown'}),

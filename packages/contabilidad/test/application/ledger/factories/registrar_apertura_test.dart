...
void main() {
  group('RegistrarApertura', () {
    ...
    test('cuenta USD usa montoNative directo', () async {
      ...
      await registrarApertura(
        ...
        deviceId: 'dev-1',
        cuentaId: cuentaId,
        montoNative: Money(amount: BigInt.from(10000), currency: CurrencyCode('USD')),
      );
    ...
    test('cuenta extranjera con amountUsd usa amountUsd directo', () async {
      ...
      await registrarApertura(
        ...
        deviceId: 'dev-1',
        cuentaId: cuentaId,
        montoNative: Money(amount: BigInt.from(10000), currency: CurrencyCode('EUR')),
        amountUsd: 11000,
      );
    ...
    test('cuenta extranjera con rate calcula usd con precision decimal', () async {
    ...
    test('rechaza cuenta no existente, falta de param extranjera, y re-apertura', () async {
      ...
      await expectLater(
        () => registrarApertura(
          ...
          deviceId: 'dev-1',
          cuentaId: cuentaId,
          montoNative: Money(amount: BigInt.from(100), currency: CurrencyCode('EUR')),
        ),
  ...
  group('Apertura + Distribucion Integration', () {
    test('Registra apertura y luego distribuye dejando apertura en cero', () async {
      ...
      catalog.saveEnvelope(Envelope(id: env1, name: 'E1', role: EnvelopeRole.ninguno, isArchived: false, updatedAt: DateTime.now()));
      catalog.saveEnvelope(Envelope(id: env2, name: 'E2', role: EnvelopeRole.ninguno, isArchived: false, updatedAt: DateTime.now()));
      ...
      await registrarApertura(
        ...
        deviceId: 'dev-1',
        cuentaId: cuentaId,
        montoNative: Money(amount: BigInt.from(300), currency: CurrencyCode('USD')),
      );
